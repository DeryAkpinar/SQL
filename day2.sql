...
--Varolan personel tablosundan pers_id,sehir,adres fieldlarina sahip personel_adres adinda yeni tablo olusturalim
...
insert into student(st_name,age) values ('Murat Can',65);
 ...
 select * from student where age>35; --yasi 35 ustu olanlari yazdirir konsolda
...
ROLLBACK TO x;--savepoint sonrasindakileri silmek icin kullanilir.

select * from ogrenciler2;--tabloyu gormek icin

commit; --commit yapmazsak hata aliriz begin-savepoitn-rollback to'dan sonra commit eklemeliyiz.
...
-- DDL - DROP komutu
DROP table isciler;--tabloyu tamamen siler.Tables'da refresh yaptigimizda da gozukmez
...
INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14');--ilk seferlik hicligi kabul eder ancak ikinci defa yazarsak hata verir
...
); --constraint tanimlamak zorunda degiliz ancak forein key boyle yazilmali.
--eger ben belirlemezsem kendisi default olarak olusturur.Kendim olusturursam istedigim isimde olusturabilirim
--primary key gibi kodun yanina forein key yazilmaz
...
DROP table calisanlar -- baglanti oldugu icin silmez.

--Parant tabloyINSERT INTO adresler VALUES('10012','Ağa Sok', '30.Cad.','Antep'); u yani primary key olan tabloyu silmek istediğimizde tabloyu silmez
