...
select isim, maas , isyeri from calisanlar --calisanlar tablosundan verileri getirir
where isyeri 
in (select marka_isim from markalar where calisan_sayisi>15.000); --markalar tablosundan verileri getirir
-- where isyeri baglanti noktasi isyeri ve markalarin
--in kullanıcaksanız parantez içine aldığınız sorgu birden fazla değer döndermelidir

select * from calisanlar; --tablosu icin birlesme yeri isyeri sutunu
