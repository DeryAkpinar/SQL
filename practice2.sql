...
--TABLOYA worker_address sutunu ve default olarakta 'Miami, FL, USA' adresini ekleyiniz.
alter table workers add worker_address varchar(100) default 'Miami,fl,usa';
select * from workers;

--Tablodaki worker_address sutununu siliniz.
...
--Tablodaki title sutununa "UNIQUE" kisitlamasi ekleyiniz.
alter table employees add constraint titlem unique (title);
--olmayacak cunku ceo'dan iki tane var.
