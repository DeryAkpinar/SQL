--GROUP BY --
/*
GROUP BY cumlecigi bir SELECT ifadesinde satirlari, sutunlari degelerine gore 
...
where urun_adi is not null -- null degerlerinin gorunmesini istemiyorsak bunu yazabiliriz
group by urun_adi
...
where maas>30000
group by ulke,cinsiyet --group by'dan sonra where kullanamyacagimiz icin from sonrasi kullaniriz
